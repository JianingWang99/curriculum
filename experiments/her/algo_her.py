...
class HER(RLAlgorithm):
    ...
    def __init__(
        ...
        self.achieved_goal_x_list = []
        self.achieved_goal_y_list = []
    ...
    def evaluate(self, epoch, pool):
        ...
        logger.record_tabular('MinReturn',
                              np.min(returns))
        if len(self.achieved_goal_x_list) > 0:
            logger.record_tabular('FinalAchievedGoal_x',
                                  self.achieved_goal_x_list[-1])
            logger.record_tabular('FinalAchievedGoal_y',
                                  self.achieved_goal_y_list[-1])      
