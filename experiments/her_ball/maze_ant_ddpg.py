...
from curriculum.experiments.her_ball.maze_ant_ddpg_algo import run_task
...
#     vg.add('outer_iters', lambda maze_id: [500])
    ...
    vg.add('env_params', [{'obs': 6, 'goal': 2, 'action': 2, 'action_max': 1.0, 'max_timesteps': 500}])
    vg.add('cycles',[50])
...
#     vg.add('seed', range(500, 520, 20))
    vg.add('seed', range(1000, 3000, 1000))
