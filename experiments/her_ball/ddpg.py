...
from curriculum.experiments.her_ball.her_sample import her_sampler
from curriculum.experiments.her_ball.replay_buffer import replay_buffer
from curriculum.experiments.her_ball.normalizer import normalizer
import timeit
import csv
import time
...
#                     print('Training...')
            ...
            with open(f'./her_data_results/her_goid_seed_{self.seed}_env_ball.csv', 'a') as fp:
                #columns: 0, 1, 2
            ...
            if True:
                ...
                #write succ to file
                with open(f'./her_data_results/experiment_1_seed_{self.seed}_env_ball.csv','a') as fd:
                    fd.write(f'{evalu}\n')
